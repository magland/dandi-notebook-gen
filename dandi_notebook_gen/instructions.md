...
4. Do exploratory research on the contents of the Dandiset by creating and executing python scripts in a tmp_scripts subdirectory to generate text output and plots.
  ...
  - After executing each script, if you created plots, review the plots using the read_image tool to be able to gain information about them. If they are not informative and useful or do not convey the expected information, you may need to adjust the script and re-run it. You should include in your thinking a summary of what you have learned from the plot image.
